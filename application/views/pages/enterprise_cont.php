...
<div class="container_main">
    ...
    <div class="left-col-aprm">
        <h1 id="ar_text">Business Continuity Plan</h1>

        <form class="ap_form">

            <label for="file-1-enter_cont">Do you have a Business Continuity plan in place? </label>
            <input class="file-1-enter_cont_in" type="file" id="file-1-enter_cont" name="file-1-enter_cont">

        </form>

    </div>
    
    <a class="button" id="prev_butt" value="Previous" href="http://localhost/codeigniter/index.php/ApRM">Previous<a>
    <input id="sav_butt" type="button" value="Save">
    <a class="button" id="nex_butt" value="Next" href="http://localhost/codeigniter/index.php/DRR">Next<a>
